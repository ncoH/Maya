...
{
  [PluginIcons("MayaHDBasicHomePlugin.Plugin.png", "MayaHDBasicHomePlugin.PluginDisabled.png")]
  public class MayaHDBasicHomePlugin : IPlugin, ISetupForm
    {
        ...
        private void noItems(string myMessage)
        {
            ...
            dlg.SetLine(1, "MayaHD found no menuitems,");
        ...
        {
            //Log.Info("MayaHD: tag=" + tag + ", tagValue=" + tagValue);
            ...
            else if (tag == "#highlightedbutton" && tagValue.IndexOf("#subitem") != -1)
            {
                ...
                //Log.Info("MayaHD : bool=" + test1 + " selected = " + selectedSubItem);

                //Log.Info("MayaHD: paus hovedmenu");
                pauseMainMenu = true;
            }
            else if (tag == "#homeitem")
            {
                //Log.Info("MayaHD: genstart hovedmenu");
                pauseMainMenu = false;
            }
        ...
        public void OnTimerEvent(object source, EventArgs e)
        {
            ...
            if (_curDay != null && _curDay.IsVisible)
            {
                ...
                GUIPropertyManager.SetProperty("#MayaHD.weather.background", icon[icon.Length-1]);
             }
            ...
            {
                Log.Info("MayaHD BasicHome plugin: Location changed to: " + _nowLabelLocation);
                ...
                if (_urlSatellite.Length > 0 && imagePath == _urlSatellite)
                {
                    ...
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.sat", "weather_icon_sat_focus.png");
                }
                else if (_urlSatellite.Length > 0)
                {
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.sat", "weather_icon_sat_nofocus.png");
                }

                if (_urlTemperature.Length > 0 && imagePath == _urlTemperature)
                {

                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.temp", "weather_icon_temp_focus.png");
                }
                else if (_urlTemperature.Length > 0)
                {
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.temp", "weather_icon_temp_nofocus.png");
                }

                if (_urlUvIndex.Length > 0 && imagePath == _urlUvIndex)
                {

                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.uv", "weather_icon_uv_focus.png");
                }
                else if (_urlUvIndex.Length > 0)
                {
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.uv", "weather_icon_uv_nofocus.png");
                }

                if (_urlWinds.Length > 0 && imagePath == _urlWinds)
                {

                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.wind", "weather_icon_wind_focus.png");
                }
                else if (_urlWinds.Length > 0)
                {
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.wind", "weather_icon_wind_nofocus.png");
                }

                if (_urlHumidity.Length > 0 && imagePath == _urlHumidity)
                {

                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.hum", "weather_icon_hum_focus.png");
                }
                else if (_urlHumidity.Length > 0)
                {
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.hum", "weather_icon_hum_nofocus.png");
                }

                if (_urlPreciptation.Length > 0 && imagePath == _urlPreciptation)
                {

                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.prec", "weather_icon_prec_focus.png");
                }
                else if (_urlPreciptation.Length > 0)
                {
                    GUIPropertyManager.SetProperty("#MayaHD.weather.icons.prec", "weather_icon_prec_nofocus.png");
                }
        ...
        public void OnTimerEvent6(object source, EventArgs e)
        {
            ...
            if (_pinIcon != null && _pinIcon.IsVisible)
            {
                ...
                GUIPropertyManager.SetProperty("#MayaHD.tvguide.recpin", _Icon);
            }
            else
            {
                GUIPropertyManager.SetProperty("#MayaHD.tvguide.recpin", string.Empty);
            }
            mytimer.Enabled = false;
        }
        ...
        {
            if (MayaHDHelper.IsAssemblyAvailable("MP-TVSeries", new Version(2, 6, 5, 1268)))
            {
                setTVSeriesEvents(false);
                getLastThreeAddedTVSeries();
            }

            if (MayaHDHelper.IsAssemblyAvailable("MovingPictures", new Version(1, 0, 6, 1116)))
            {
        ...
        private void DeInitMostRecents()
        {
            ...
            if (MayaHDHelper.IsAssemblyAvailable("MP-TVSeries", new Version(2, 6, 3, 1239)))
            {
                // unsubscribe
                setTVSeriesEvents(false);
            }
        ...
        void getLastThreeAddedMovies()
        {
            ...
            filteredMovies.RemoveAll(movie => movie.DateAdded < DateTime.Now.Subtract(new TimeSpan(365, 0, 0, 0, 0)));
            ...
            for (int i = 1; i < 4; i++)
            {
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".title", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".thumb", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".fanart", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".runtime", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".genres", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".year", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.movie" + i.ToString() + ".score", string.Empty);
            ...
            foreach (DBMovieInfo movie in filteredMovies)
            {
                ...
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".title", movie.Title);
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".thumb", movie.CoverThumbFullPath);
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".fanart", movie.BackdropFullPath);
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".runtime", GetMovieRuntime(movie) + " min");
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".genres", genre.ToString());
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".year", movie.Year.ToString());
                SetProperty("#MayaHD.recentlyAdded.movie" + mrMovieNumber.ToString() + ".score", Math.Round(movie.Score, MidpointRounding.AwayFromZero).ToString());
                ++mrMovieNumber;
                if (mrMovieNumber == 4)
                    break;
            }
        ...
        void getLastThreeAddedTVSeries()
        {
            ...
            RecentlyAdded.recentAddedEpisodes = DBEpisode.GetMostRecent(MostRecentType.Created, 365, 3, true);

            // Clear the properties first
            for (int i = 1; i < 4; i++)
            {
                SetProperty("#MayaHD.recentlyAdded.series" + i.ToString() + ".title", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.series" + i.ToString() + ".episodetitle", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.series" + i.ToString() + ".episodenumber", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.series" + i.ToString() + ".season", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.series" + i.ToString() + ".thumb", string.Empty);
                SetProperty("#MayaHD.recentlyAdded.series" + i.ToString() + ".fanart", string.Empty);
            }
            ...
            foreach (DBEpisode episode in RecentlyAdded.recentAddedEpisodes)
            {
                ...
                if (series != null)
                {
                    SetProperty("#MayaHD.recentlyAdded.series" + mrEpisodeNumber.ToString() + ".title", series.ToString());
                    SetProperty("#MayaHD.recentlyAdded.series" + mrEpisodeNumber.ToString() + ".episodetitle", episode[DBEpisode.cEpisodeName]);
                    SetProperty("#MayaHD.recentlyAdded.series" + mrEpisodeNumber.ToString() + ".episodenumber", episode[DBEpisode.cEpisodeIndex]);
                    SetProperty("#MayaHD.recentlyAdded.series" + mrEpisodeNumber.ToString() + ".season", episode[DBEpisode.cSeasonIndex]);
                    SetProperty("#MayaHD.recentlyAdded.series" + mrEpisodeNumber.ToString() + ".thumb", series.Poster);
                    SetProperty("#MayaHD.recentlyAdded.series" + mrEpisodeNumber.ToString() + ".fanart", Fanart.getFanart(episode[DBEpisode.cSeriesID]).FanartFilename);
                    ++mrEpisodeNumber;
                }
            }
            setMostRecents();
        ...
        void getMostRecents()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                try
                {
                    mostTVSeriesRecents[i] = GUIPropertyManager.GetProperty("#MayaHD.recentlyAdded.series" + (i + 1).ToString() + ".fanart");
                }
                catch { }
                try
                {
                    mostMovPicsRecents[i] = GUIPropertyManager.GetProperty("#MayaHD.recentlyAdded.movie" + (i + 1).ToString() + ".fanart");
                }
                catch { }
        ...
        private void setMostRecents()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                seasonNum = GUIPropertyManager.GetProperty("#MayaHD.recentlyAdded.series" + (i + 1).ToString() + ".season");
                episodeNum = GUIPropertyManager.GetProperty("#MayaHD.recentlyAdded.series" + (i + 1).ToString() + ".episodenumber");

                if (seasonNum != null && episodeNum != null)
                {

                    formattedSE = "S" + seasonNum.PadLeft(2, '0') + "E" + episodeNum.PadLeft(2, '0');
                    SetProperty("#MayaHD.RecentlyAdded." + (i + 1).ToString(), formattedSE);
                }
        ...
        public void OnAction(Action action)
        {
            ...
            if (actwin == 2600) //Weather screen
            {
                ...
                /*
                    ...
                    if (lastupdate.Length > 0)
                    {
                        ...
                        GUIPropertyManager.SetProperty("#MayaHD.weather.update.date", finallongdate);
                        GUIPropertyManager.SetProperty("#MayaHD.weather.update.time", shortdate);
                    }
                    */
                ...
                {
                    Log.Info("MayaHD BasicHome plugin: exception in DateTime.Parse()");
                }
            }
            ...
            {
                //Log.Info("MayaHDSkin: " + action.wID.ToString());
                //GUIControl.HideControl(35, 566);
                ...
                else if (GUIWindowManager.ActiveWindow == 35 && action.wID == Action.ActionType.ACTION_MOVE_RIGHT)
                {
                    ...
                    if (vWindow != null)
                    {
                        ...
                        GUIControl control3 = vWindow.GetControl(901);
                        GUIControl control4 = vWindow.GetControl(902);
                        //GUIControl control5 = vWindow.GetControl(119);
                        //GUIControl control6 = vWindow.GetControl(123);
                        ...
                        bReturn3 = control3.Focus;
                        bReturn4 = control4.Focus;
                        //bReturn5 = control5.Visible;
                        //bReturn6 = control6.Visible;
                        ...
                        if (bReturn1 | bReturn2 | bReturn3 | bReturn4)
                        {
                            ...
                            {
                                GUIControl.FocusControl(35, 221);
                            }
                            else if (loc_recent == "TVSeries")
                            {
                                GUIControl.FocusControl(35, 231);
                            }
                            else if (loc_recent == "MyFilms")
                            {
                                GUIControl.FocusControl(35, 91919988);
                            }
                            else
                            {
                                return;
                ...
                // Down-key was pressed in home screen
                ...
                
                  {
                    ...
                    if (vWindow != null)
                    {
                        ...
                        //MyFilms
                        GUIControl control7 = vWindow.GetControl(91919988);
                        GUIControl control8 = vWindow.GetControl(91919989);
                        GUIControl control9 = vWindow.GetControl(91919990);
                        ...
                        if (!aReturn1 && !aReturn2 && !aReturn3 && !aReturn4 && !aReturn5 && !aReturn6 && !aReturn7 && !aReturn8 && !aReturn9)
                        {
                ...
                else if (GUIWindowManager.ActiveWindow == 35 && (action.wID == Action.ActionType.ACTION_MOUSE_CLICK || action.wID == Action.ActionType.ACTION_SELECT_ITEM)) //Sure??
                {
                    ...
                    bool aReturn12 = false;
                    bool aReturn13 = false;
                    ...
                    if (vWindow != null)
                    {
                        ...
                        //MyFilms
                        GUIControl control11 = vWindow.GetControl(91919988);
                        GUIControl control12 = vWindow.GetControl(91919989);
                        GUIControl control13 = vWindow.GetControl(91919990);
                        ...
                        aReturn12 = control12.Focus;
                        aReturn13 = control13.Focus;
                        ...
                        if (!aReturn1 && !aReturn2 && !aReturn3 && !aReturn4 && !aReturn5 && !aReturn6 && !aReturn7 && !aReturn8 && !aReturn9 && !aReturn10 && !aReturn11 && !aReturn12 && !aReturn13)
                        {
                            ...
                            if (pauseMainMenu == false)
                            {
                                ...
                                //Log.Info("MayaHD Skin MainmenuParameter:" + _hyperLinkParameter);
                            ...
                            else
                            {
                                ...
                                //Log.Info("MayaHD Skin SubmenuParameter:" + _hyperLinkParameter);
                            }
                            if (location > -1)
                            {
                ...
                else if (action.wID == Action.ActionType.ACTION_SWITCH_HOME || action.wID == Action.ActionType.ACTION_HOME || action.wID == Action.ActionType.ACTION_PREVIOUS_MENU)
                {
                    ...
                    GUIControl.HideControl(35, 566);
                    //Log.Info("MayaHDSkin: User went home");
                    if (ms_headings.Count > 0)
                    {
                        SetProperty("#homeitem", ms_headings[mypointer]);
                    }
        ...
        public void Start()
        {
            ...
            // Check to see if MayaHDSkin is the selected skin (halt plugin if not)
            using (MediaPortal.Profile.Settings xmlreader = new MediaPortal.Profile.Settings(Config.GetFile(Config.Dir.Config, "MediaPortal.xml")))
            {
            ...
            if (myskin.IndexOf("MayaHD") != -1)
            {
                Log.Info("MayaHD BasicHome plugin: Skin found");
                //Skin is MayaHD, continue

                InitMostRecents();

                // Load settings and set the default item
                if (!File.Exists(Config.GetFile(Config.Dir.Config, "MayaHDSkin.xml")))
                {
                    Log.Info("MayaHD BasicHome plugin: Config-file MayaHDSkin.xml not found.");
                    Stop();
                }
                else
                {
                    ...
                    {
                            string mytest = xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemName0", "");
                            if (mytest.Length > 0)
                            {
                                ...
                                do
                                {
                                    ...
                                    mytest = xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemName" + a, "");
                                    if (mytest != "")
                                    {
                                        ms_headings.Add(xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemName" + a, ""));
                                        ms_windowids.Add(xmlreader.GetValueAsInt("MayaHDBasicHome", "menuItemHyperlink" + a, 0));

                                        if (xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemBgImage" + a, "").Contains("jpg"))
                                        {
                                            ms_bgimages.Add("animations/basichome/" + xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemBgImage" + a, ""));
                                        }
                                        else
                                        {
                                            ms_bgimages.Add(xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemBgImage" + a, ""));
                                        }

                                        ms_window_params.Add(xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemParameter" + a, ""));
                                        ms_recentMedia.Add(xmlreader.GetValueAsString("MayaHDBasicHome", "menuItemRecentMedia" + a, ""));
                            ...
                            {
                                Log.Info("MayaHD BasicHome plugin: No menuitems configured");
                                Stop();
                            }



                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "enWeather", 0) == 1)
                        {
                            SetProperty("#MayaHD.weather.visible", "yes");
                        }



                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "enRSS", 0) == 1)
                        {
                            SetProperty("#MayaHD.rss.visible", "yes");
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "clockBasicHome", 0) == 1)
                        {
                            SetProperty("#MayaHD.clock.clockBasicHome", "yes");
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "clockHome", 0) == 1)
                        {
                            SetProperty("#MayaHD.clock.clockHome", "yes");
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "clockElsewhere", 0) == 1)
                        {
                            SetProperty("#MayaHD.clock.clockElsewhere", "yes");
                        }
                        
                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "fanartTVSeries", 0) == 1)
                        {
                            if (xmlreader.GetValueAsInt("MayaHDBasicHome", "Enable_iFX", 0) == 1)
                            {
                                SetProperty("#MayaHD.fanart.TVSeries", "yes");
                            }
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "fanartMovingPictures", 0) == 1)
                        {
                            if (xmlreader.GetValueAsInt("MayaHDBasicHome", "Enable_iFX", 0) == 1)
                            {
                                SetProperty("#MayaHD.fanart.MovingPictures", "yes");
                            }
                        }


                       // if (xmlreader.GetValueAsInt("MayaHDBasicHome", "recentlyAddedSeries", 0) == 1)
                       // {
                       //     if (xmlreader.GetValueAsInt("MayaHDBasicHome", "Enable_iFX", 0) == 1)
                       //     {
                       //         SetProperty("#MayaHD.recentlyAddedSeries", "yes");
                       //     }
                       // }

                        
                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "EnableBackgroundImage", 0) == 1)
                        {
                            if (xmlreader.GetValueAsInt("MayaHDBasicHome", "Enable_iFX", 0) == 1)
                            {
                                SetProperty("#MayaHD.backgroundImage", "yes");
                            }
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "fanartMusic", 0) == 1)
                        {
                            if (xmlreader.GetValueAsInt("MayaHDBasicHome", "Enable_iFX", 0) == 1)
                            {
                                SetProperty("#MayaHD.fanart.Music", "yes");
                            }
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "EnableBackgroundImagePlugins", 0) == 1)
                        {
                            if (xmlreader.GetValueAsInt("MayaHDBasicHome", "Enable_iFX", 0) == 1)
                            {
                                SetProperty("#MayaHD.bgImage.Plugins", "yes");
                            }
                        }

                        if (xmlreader.GetValueAsInt("MayaHDBasicHome", "FanartScraper", 0) == 1)
                        {
                            SetProperty("#MayaHD.show.scraping", "yes");
                        }
        ...
        public void Stop()
        {
            Log.Info("MayaHD BasicHome plugin: Stopped");
        }
        ...
        {
            return "MayaHD BasicHome Configuration";
        }

        // Returns the description of the plugin is shown in the plugin menu
        public string Description()
        {
            return "BasicHome.xml modifier, part of the MayaHD skin for MediaPortal (by joostzilla and pilehave).";
        }
        ...
        {
            MayaHDSkinConfig config = new MayaHDSkinConfig();
            config.ShowDialog();
        }
